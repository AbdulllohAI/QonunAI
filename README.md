...
[![Tests](https://img.shields.io/badge/tests-83%20passing-2ea44f)](backend/tests/test_units.py)
...
83 unit tests, no database or network required — verified passing. They cover
